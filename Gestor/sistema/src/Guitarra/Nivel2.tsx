...
export const Nivel2Guitarra = () => {
    const contextApp = useContext(ContextApp);
    const navigate = useNavigate();

    const [juego, setJuego] = useState<IJuego>({
        nombre: 'Nivel 2: Guitarra',
        dificultad: 'Normal',
        puntosAcomulados: 0,
        retroalimentacion: '',
        intentos: 5,
    ...
    const respuestaCorrecta1 = "GUITARRA";
            ...
            <div className="container white-bg">
                ...
                <div className="row">
                    <div className="col-md-6 columna">
                        <div className="d-flex flex-column align-items-center">
                            <img
                                src="https://st.depositphotos.com/1024768/2955/v/950/depositphotos_29551501-stock-illustration-guitar-clip-art-cartoon-illustration.jpg"
                ...
                <div className="row">
                    <div className="col-md-6 columna text-center">
                        <button disabled={juego.intentos === 0 || juego.puntosAcomulados >= 20} className="boton" onClick={handleGuardarClick}>Guardar</button>
                    </div>
                    <div className="col-md-6 columna text-center">
                    ...
                    <div className="col-md columnana text-center">
                        <button className="boton boton-regresar" onClick={() => navigate("/Nivel1Guitarra")}>Regresar</button>
                    </div>
                </div>
                <div className="row">
