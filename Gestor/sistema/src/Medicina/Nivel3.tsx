...
const PALABRA_AHORCADO = 'MEDICAMENTO';

export const Nivel3Medicina = () => {
  const navigate = useNavigate();
  const contextApp = useContext(ContextApp);

  const [juego, setJuego] = useState<IJuego>({
    nombre: 'Nivel 3: Medicina',
    dificultad: 'Fácil',
    puntosAcomulados: 0,
    retroalimentacion: '',
    intentos: 10,
  ...
  return (
    <>
      ...
      <div className="container white-bg ahorcado-container">
        ...
        <div className="row">
          <div className="col-12">
            <p className="instrucciones">Adivina la palabra: Empieza con M</p>
        ...
        <div className="row">
          <div className="col-12">
            ...
            <div className="col-md columnana text-center">
              <button className="boton boton-regresar" onClick={() => navigate("/Nivel2Medicina")}>Regresar</button>
            </div>
          </div>
        </div>
      </div>
