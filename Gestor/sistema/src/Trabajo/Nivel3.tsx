                ...
                <div className="row">
                    ...
                    <div className="col-6">
                        ...
                        <div className="letras-container">
                            {'MTEDICHANTRBJO'.split('').map((letra) => (
                                <button
                                    key={letra}
                        ...
                        <div className="botones-container">
                            ...
                            <div className="col-md columnana text-center">
                                <button className="boton boton-regresar" onClick={() => navigate("/Nivel2Trabajo")}>Regresar</button>
                            </div>
                        </div>
                    </div>
                </div>
