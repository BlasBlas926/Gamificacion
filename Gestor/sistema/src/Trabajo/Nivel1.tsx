...
const PALABRA_AHORCADO = 'TRABAJO';

export const Nivel1Trabajo = () => {
  const navigate = useNavigate();
  const contextApp = useContext(ContextApp);

  const [juego, setJuego] = useState<IJuego>({
    nombre: 'Nivel 1: Trabajo',
    dificultad: 'Fácil',
    puntosAcomulados: 0,
    retroalimentacion: '',
    intentos: 10,
  ...
  return (
    <>
      ...
      <div className="container white-bg ahorcado-container">
        ...
        <div className="row">
          <div className="col-12">
            <p className="instrucciones">Adivina la palabra: Empieza con T</p>
        ...
        <div className="row">
          <div className="col-12">
            <button onClick={handleGuardarClick} disabled={juego.intentos === 0 || juego.puntosAcomulados >= 10} className="guardar-button">
              Responder
            </button>
