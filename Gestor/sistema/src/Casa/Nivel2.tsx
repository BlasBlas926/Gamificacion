...
export const Nivel2Casa = () => {
    ...
    const [juego, setJuego] = useState<IJuego>({
        ...
        intentos: 3,
        porcentaje: 100,
        palabra: ["CASA", "FAMILIA"],
        usuarioId: contextApp.id,
    });

    const sopaDeLetras = [
        ['C', 'A', 'S', 'A', 'O', 'R', 'E', 'E', 'E', 'H', 'C', 'P', 'B'],
        ['G', 'F', 'A', 'M', 'I', 'L', 'I', 'A', 'R', 'A', 'P', 'Ñ', 'C'],
                    ...
                    <div className="row">
                        <div className="col-12 text-center">
                            ...
                            <div className="col-md columnana text-center">
                                <button className="boton boton-regresar" onClick={() => navigate("/Nivel1Casa")}>Regresar</button>
                            </div>
                        </div>
                    </div>
                    <div className="row">
