...
export const Nivel1Tortilla = () => {
    ...
    const [juego, setJuego] = useState<IJuego>({
        nombre: 'Nivel 1: Tortilla',
        dificultad: 'Facil',
        puntosAcomulados: 0,
        retroalimentacion: '',
        intentos: 10,
        porcentaje: 100,
        palabra: ["TORTILLA", "MEXICO", "CANTINA"],
        usuarioId: ''
    });
    ...
    const handleGuardarClick = async () => {
        ...
        if (palabrasFormadas.length === juego.palabra.length) {
            ...
            setJuego((prevState) => ({
                ...prevState,
                puntosAcomulados: prevState.puntosAcomulados + 10,
