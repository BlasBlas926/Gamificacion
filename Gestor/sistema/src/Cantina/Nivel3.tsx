...
const PALABRA_AHORCADO = 'CANTINA';

export const Nivel3Cantina = () => {
  const navigate = useNavigate();
  const contextApp = useContext(ContextApp);

  const [juego, setJuego] = useState<IJuego>({
    nombre: 'Nivel 3: Cantina',
    dificultad: 'Dificil',
    puntosAcomulados: 0,
    retroalimentacion: '',
    intentos: 3,
  ...
  return (
    <>
      ...
      <div className="container white-bg ahorcado-container">
        ...
        <div className="row">
          <div className="col-12">
            <p className="instrucciones">Adivina la palabra: Empieza con C</p>
        ...
        <div className="row">
          <div className="col-12">
            <button disabled={juego.intentos === 0 || juego.puntosAcomulados >= 25} onClick={handleGuardarClick} className="guardar-button">
              Responder
            </button>
            ...
            <div className="col-md columnana text-center">
              <button className="boton boton-regresar" onClick={() => navigate('/Nivel2Cantina')}>Regresar</button>
            </div>
          </div>
        </div>
      </div>
