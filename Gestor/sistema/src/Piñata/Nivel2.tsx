...
const PALABRA_AHORCADO = 'MEDICINA';
export const Nivel2Piñata = () => {
  const contextApp = useContext(ContextApp);
  const navigate = useNavigate();

  const [juego, setJuego] = useState<IJuego>({
    nombre: 'Nivel 2: Piñata',
    dificultad: 'Normal',
    puntosAcomulados: 0,
    retroalimentacion: '',
    intentos: 5,
  ...
  const insertarJuego = async (juego: IJuego) => {
    try {
      // Solo inserta en la base de datos si la respuesta es correcta
  ...
  return (
    <>
      ...
      <div className="container white-bg ahorcado-container">
        ...
        <div className="row">
          <div className="col-12">
            <p className="instrucciones">Adivina la palabra: Empieza con M y termina con A</p>
        ...
        <div className="row">
          <div className="col-12">
            ...
            <div className="col-md columnana text-center">
              <button className="boton boton-regresar" onClick={() => navigate("/Nivel1Piñata")}>Regresar</button>
            </div>
