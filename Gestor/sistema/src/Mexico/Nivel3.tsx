...
export const Nivel3Mexico = () => {
    ...
    const respuestaCorrecta = "MÉXICO";
                ...
                <div className="row">
                    ...
                    <div className="col-6">
                        ...
                        <div className="letras-container">
                            {'AQÉMCIXOTHRBSJN'.split('').map((letra) => (
                                <button
                                    key={letra}
                        ...
                        <div className="botones-container">
                            ...
                            <div className="col-md columnana text-center">
                                <button className="boton boton-regresar" onClick={() => navigate("/Nivel3Mexico")}>Regresar</button>
                            </div>
                        </div>
                    </div>
                </div>
