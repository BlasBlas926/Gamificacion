...
export const Nivel2Mexico = () => {
    ...
    const respuestaCorrecta1 = "C-a-n-t-i-n-a";
    const respuestaCorrecta2 = "C-a-s-a";
            ...
            <div className="container white-bg">
                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <p className="instrucciones">Ejemplo: <span className="ejemplo">C-A-S-A</span></p>
                    </div>
                </div>
                <div className="row">
                ...
                <div className="row">
                    ...
                    <div className="col-md columnana text-center">
                        <button className="boton boton-regresar" onClick={() => navigate("/Nivel1Mexico")}>Regresar</button>
                    </div>
                </div>
                <div className="row">
